...
public class SiteInventoryItem {
    ...
    public SiteInventoryItem(int id, String siteCode, String merchandiseCode, int stockQty) {
        this.id = id;
    ...
    public SiteInventoryItem(String siteCode, String merchandiseCode, int stockQty) {
        this.siteCode = siteCode;
        this.merchandiseCode = merchandiseCode;
        this.stockQty = stockQty;
    }
